...
const Tr = (props) => {
  ...
  return (
    <tr class="d-item">
      ...
      <td class="d-item--category">{mapping_value(order_status)}</td>
      <td class="d-item--des">{slash(address)}</td>
      <td class="d-item--des">{slash(description)}</td>
      <Link to={`/admin/orders/${id}`} class="d-item--icon d-item--edit">
        <svg
      ...
      {order_status == "PENDING" && <td class="d-item--icon d-item--delete" onClick={() => props.completeOrder(id)}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"
        >
